    ...
    def sos(self):
        ...
        for ogrenci in self.sinif_ogrencileri:
            if "9" in ogrenci[3]:
                ...
                onbirler +=1
            elif "12" in ogrenci[3]:
                onikiler +=1
        for k in range(2):
            ck[self.sinif_adi].append([" "])
        icerik = "9 Siniflar = {},  10 Siniflar = {},   11 Siniflar = {},   12 Siniflar = {}".format(dokuzlar,onlar,onbirler,onikiler)
        ck[self.sinif_adi].append(icerik.split(","))
        return print("9 Siniflar = {},  10 Siniflar = {},   11 Siniflar = {},   12 Siniflar = {},  ".format(dokuzlar,onlar,onbirler,onikiler))
